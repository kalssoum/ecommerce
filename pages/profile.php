...
$Profil = $transaction->getProfilByid($_SESSION['user']['id']);
if (isset($_POST) && isset($_POST['clique'])) {
  $nom = $_POST['nom'];
  $prenom = $_POST['prenom'];
  $adresse = $_POST['adresse'];
  $tel = $_POST['tel'];
  $users = $transaction->updateProfil($_SESSION['user']['id'],$nom, $prenom, $adresse, $tel);
}
?>
...
<form action="profile.php" method="POST" class="row g-3 boutiquierform" >
  <div class="col-md-6">
