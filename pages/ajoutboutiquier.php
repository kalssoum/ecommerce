<?php
//use session pour securiser les pages
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="men" href="commandeclient.php">Commandes Clients</a>
        </li>
        <li class="nav-item dropdown">
          <a class="men dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            <li><a class="dropdown-item active" href="ajoutboutiquier.php">Ajouter</a></li>
...
<form action="ajoutboutiquier.php" method="POST" class="row g-3 boutiquierform" >
  ...
  <div class="col-md-4">
    ...
    <select name="profil" id="inputState" class="form-select">
